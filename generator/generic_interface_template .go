...
var genericIinterfaceFuncs = template.FuncMap{
...
const genericInterfaceTemplate string = `{{.Header}}// Code generated by counterfeiter. DO NOT EDIT.
...
{{range .Methods -}}
func (fake *{{$.Name}}[T]) {{.Name}}({{.Params.AsNamedArgsWithTypes}}) {{.Returns.AsReturnSignature}} {
	{{- range .Params.Slices}}
...
func (fake *{{$.Name}}[T]) {{Title .Name}}CallCount() int {
	fake.{{UnExport .Name}}Mutex.RLock()
	defer fake.{{UnExport .Name}}Mutex.RUnlock()
	return len(fake.{{UnExport .Name}}ArgsForCall)
}

func (fake *{{$.Name}}[T]) {{Title .Name}}Calls(stub func({{.Params.AsArgs}}) {{.Returns.AsReturnSignature}}) {
	fake.{{UnExport .Name}}Mutex.Lock()
...
{{if .Params.HasLength -}}
func (fake *{{$.Name}}[T]) {{Title .Name}}ArgsForCall(i int) {{.Params.AsReturnSignature}} {
	fake.{{UnExport .Name}}Mutex.RLock()
	defer fake.{{UnExport .Name}}Mutex.RUnlock()
...
{{if .Returns.HasLength -}}
func (fake *{{$.Name}}[T]) {{Title .Name}}Returns({{.Returns.AsNamedArgsWithTypes}}) {
	fake.{{UnExport .Name}}Mutex.Lock()
	defer fake.{{UnExport .Name}}Mutex.Unlock()
	fake.{{.Name}}Stub = nil
...
func (fake *{{$.Name}}[T]) {{Title .Name}}ReturnsOnCall(i int, {{.Returns.AsNamedArgsWithTypes}}) {
	fake.{{UnExport .Name}}Mutex.Lock()
	defer fake.{{UnExport .Name}}Mutex.Unlock()
	fake.{{.Name}}Stub = nil
...
func (fake *{{.Name}}[T]) Invocations() map[string][][]interface{} {
...
func (fake *{{.Name}}[T]) recordInvocation(key string, args []interface{}) {
