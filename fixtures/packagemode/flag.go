...
//counterfeiter:generate -p github.com/jibecompany/counterfeiter/v6/fixtures/packagemode
//counterfeiter:generate -o flagcustomfakesdir -p github.com/jibecompany/counterfeiter/v6/fixtures/packagemode
