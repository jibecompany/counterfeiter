# `counterfeiter` [![Go](https://github.com/jibecompany/counterfeiter/actions/workflows/go.yml/badge.svg)](https://github.com/jibecompany/counterfeiter/actions/workflows/go.yml) [![CircleCI](https://circleci.com/gh/jibecompany/counterfeiter.svg?style=svg)](https://circleci.com/gh/jibecompany/counterfeiter) [![Build status](https://ci.appveyor.com/api/projects/status/0j2v7pt06lp9yanm/branch/master?svg=true)](https://ci.appveyor.com/project/jibecompany/counterfeiter/branch/master)
...
import (
	_ "github.com/jibecompany/counterfeiter/v6"
)
...
//go:generate go run github.com/jibecompany/counterfeiter/v6 . MySpecialInterface
...
```shell
$ go run github.com/jibecompany/counterfeiter/v6
...
```shell
$ GO111MODULE=off go get -u github.com/jibecompany/counterfeiter
$ counterfeiter
...
```shell
$ go run github.com/jibecompany/counterfeiter/v6 path/to/foo MySpecialInterface
...
For more examples of using the `counterfeiter` API, look at [some of the provided examples](https://github.com/jibecompany/counterfeiter/blob/master/generated_fakes_test.go).
...
```shell
$ go run github.com/jibecompany/counterfeiter/v6 github.com/go-redis/redis.Pipeliner
```
